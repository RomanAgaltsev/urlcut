...
//
//	rowsIns := sqlmock.NewRows([]string{"id", "long_url", "base_url", "url_id", "created_at", "uid"}).
//		AddRow(1, longURL, BaseURL, urlID, time.Now(), uid)
//	rowsSel := sqlmock.NewRows([]string{"id", "long_url", "base_url", "url_id", "created_at", "uid"}).
//		AddRow(1, longURL, BaseURL, urlID, time.Now(), uid)
//
//	mock.ExpectBegin()
