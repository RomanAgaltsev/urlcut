...
//
//	mockgen -destination=mocks/mock_repository.go -package=mocks github.com/RomanAgaltsev/urlcut/internal/interfaces Repository
//
...
func (m *MockRepository) Store(url *model.URL) error {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Store(url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Store", reflect.TypeOf((*MockRepository)(nil).Store), url)
}
